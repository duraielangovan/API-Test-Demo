...
public class VeyyonKafkaProducer<T extends Object> {

    protected Logger logger = LoggerFactory.getLogger(VeyyonKafkaProducer.class);
    ...
    public VeyyonKafkaProducer<T> setBroker(String broker) {
        this.broker = broker.trim();
        return this;
    }

    public VeyyonKafkaProducer<T>  setTopicName(String topicName) {
        this.topicName = topicName.trim();
        return this;
    }

    public VeyyonKafkaProducer<T>  setSecurityProtocol(String securityProtocol) {
        this.securityProtocol = securityProtocol.trim();
        return this;
    }

    public VeyyonKafkaProducer<T>  setSslTrustStoreLocation(String sslTrustStoreLocation) {
